...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// Ok, here we go! Since the whole applet window has dimensions 800x600, I will
		// start by calculating the correct anchors for map2. 
		map2 = new UnfoldingMap(this, 400, 50, 350, 500, provider);
		// These coordinates point to the school I attended.
		map2.zoomAndPanTo(zoomLevel, new Location(51.6617003f ,7.0959503f));
